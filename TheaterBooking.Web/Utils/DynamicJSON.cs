...
namespace TheaterBooking.Web.Utils
{
    ...
    /// <summary>
    /// www.drowningintechnicaldebt.com/ShawnWeisfeld/archive/2010/08/22/using-c-4.0-and-dynamic-to-parse-json.aspx
    /// </summary>
    ...
    {
        public static dynamic Parse(string jsonData)
        {
